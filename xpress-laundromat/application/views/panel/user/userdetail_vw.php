                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<a target="_blank" href="<?php echo BASE.'panel/orders/view_invoice/'.$order->id;?>" class="btn btn-warning">Invoice</a>
									<?php } ?>
									</td>
                                    <td>
                                        <?php 
									...
									{
										echo $finalAmount= $order->final_amount;
									}
									else
									{ 	
										echo $finalAmount= $order->total_amount+$order->sc_SGST+$order->sc_CGST+$order->sc_IGST-$order->discount;
									}
                                ...
                                <tr class="toggle" id="detail_<?=$order->id?>">
                                    <td colspan="7">
                                        ...
                                        <table class="table table-responsive">
											...
											<tr>
											<td><label>Clothes Weight</label></td>
