...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Bookdate Wise Sales Report 
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?=BASE?>panel/home"><i class="fa fa-home"></i></a></li>
            <li class="active">Bookdate Wise Sales Report </li>
        </ol>
    </div>
</div>
                <!-- /.row -->
...
<div class="table-responsive">
    <div class="col-sm-8 margin-bottom-20">
        ...
        <form action="<?=BASE?>panel/reports/exportbookdate-sales" target="_blank" id="exportxls" method="post" >
