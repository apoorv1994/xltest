    ...
    <div class="modal-dialog">
        ...
        <div class="row modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Add Cloth Details [Service type]</h4>
            </div>
            <form method="post" id="clothFrm">
                <div class="modal-body">
                    ...
                    <div class="form-group" style="display:none;">
                            <label for="concept" class="col-sm-3 control-label">Items Ironed</label>
                            <div class="col-sm-9" >
                    ...
                    <div class="col-md-5 col-md-offset-5 ">
                        <div id="loader"></div>
                        <button type="button" id="clothBtn" class="btn btn-success">Print Tags</button>
                        <!-- <button type="button" id="clothBtn" class="btn btn-success">Save</button><br><br> -->
                    </div>
                    <p style="visibility:hidden; margin-bottom: -6px; ">hidden</p>
                    ...
                    <label style="margin: 6px; display:none;" class="control-label">Clothes Details: (price / quantity)</p>

                         <!-- for premium  wash -->
         
                    <div class="col-sm-12" style="border: 1px solid #e3e3e3; padding: 0px; display:none; ">
                        <div class="col-sm-6" style="padding: 0px; border-right: 1px solid #e3e3e3">
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Shirt/T-shirt </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Ladies Top </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Kurta  </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Seatshirt / Sweeter  </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                             <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Pants / Trousers</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                           
                        </div>
                        <div class="col-sm-6" style="padding: 0px;">
                           
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Towel </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Curtains </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Bedsheets </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Others </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" style="border: 1px solid #e3e3e3; padding: 0px; display: none;">
                        <div class="col-sm-6" style="padding: 0px;  border-right: 1px solid #e3e3e3">
                            ...
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Shawl / Stole  </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Kurta  </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Sarees</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Blazers / Jackets</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Suit (2 Pc.)</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                             
                        </div>
                        <div class="col-sm-6" style="padding: 0px;">
                           
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Sweater / Sweat Shirt </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Quilt / Single Blanket </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Curtains </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Blanket (double) </div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Ladies Dress</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                            <div class="col-sm-12" style="margin:5px 0px;"><div class="col-sm-6">Other</div><input class="col-sm-3" style="padding: 0px" type="number"><input class="col-sm-3" type="number" style="padding: 0px"></div>
                        </div>
                    </div>

                    <p style="visibility:hidden; margin-bottom: -6px;">hidden</p>
                    <div class="form-group " style="display:none;">
                            <label for="concept" class="col-sm-3 control-label">Extra Amount Adjustments </label>
                            <div class="col-sm-9">
