        ...
        <tbody>
           ...
           <tr>
               <td>Amount Received already</td>
                ...
                <input type="hidden" name="amt_received" class="total" id="amt_received" value="<?=$invoice->total_amount?>">
                <?php }?>
			...
			<?php } ?>
			<?php if($item_data['towel']['cost']>0 || $item_data['towel']['blanket']>0){?>
            <tr id="towels">
            ...
            <tr>
                <td>Discount</td>
                <td align="right">                    
                    <input type="number" class="form-control totalD" style="width: 80px;" value="<?=  number_format($invoice->discount,2);?>" name="discount" id="discount">		
                </td>
            </tr>
			<tr>
                <td>SGST</td>
                <td align="right">                    
                    <input type="number" class="form-control total" style="width: 80px;" value="<?=  number_format($invoice->sc_SGST,2);?>" name="sc_SGST" id="sc_SGST">		
                </td>
            </tr>
			 <tr>
                <td>CGST</td>
                <td align="right">                    
                    <input type="number" class="form-control total" style="width: 80px;" value="<?=  number_format($invoice->sc_CGST,2);?>" name="sc_CGST" id="sc_CGST">		
                </td>
            </tr>
			 <tr>
                <td>IGST</td>
                <td align="right">                    
                    <input type="number" class="form-control total" style="width: 80px;" value="<?=  number_format($invoice->sc_IGST,2);?>" name="sc_IGST" id="sc_IGST">		
                </td>
            </tr>
            <tr>
                <td>Total Amount</td>
                <td class="text-right">
                    <?php $total = $invoice->total_amount+$pick_cost+$price+$invoice->sc_SGST+$invoice->sc_CGST+$invoice->sc_IGST-$invoice->discount;?>
