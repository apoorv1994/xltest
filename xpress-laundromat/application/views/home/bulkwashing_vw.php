    ...
    <div class="col-sm-12 padding-bottom-20 padding-top-20">
        ...
        <div class="col-sm-4 bold fs-16">
	       <!--  <input type='button' value='-' class='qtyminus1' data-p="no"  field='quantity' /> -->
	        ...
	        <div class="col-sm-6"><input type="radio" id="w_iron" name="wash_type" value="iron" checked> Wash &amp; Iron </div>
	        <div class="col-sm-6"><input type="radio" id="w_fold" name="wash_type" value="fold">Wash &amp; Fold</div>
        </div>
