...
<?php $this->load->view('home/wallet_vw');?>
    ...
    <div class="container">
            <div class="col-xs-12 col-lg-offset-3 col-lg-6 well m-t-30">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><i class="fa fa-inr"></i> <?=$total?></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><i class="fa fa-inr"></i> <span  id="final_amount"><?=$total?></span></td>
                            </tr>
                            <tr>
                                <td>
        ...
        $('#couponBtn').click(function(){
            ...
            $.post(url,data,function(success){
                ...
                {   //console.log(parseInt(total_a));
                    ...
                    {
                        final_amount = $('#totalAmount').val()-discount;
