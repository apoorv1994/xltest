...
<div class="container-fluid container-fixed-lg no-padding">
    <div class="container">
        <div class="col-xs-12 col-sm-6 slottop">
            ...
            <div class="col-xs-12 col-sm-8 p-l-20 pdata">
                <h3 class="col-xs-12 col-sm-8">Hi <?=$details->firstname?></h3>
                <div class="col-xs-12 col-sm-12 no-padding">
                    <div class="col-xs-6 col-sm-6">Phone No.</div>
                    <div class="col-xs-6 col-sm-6">: +91 <?=$details->phone_no?></div>
                </div>
                <div class="col-xs-12 col-sm-12 no-padding">
                    <div class="col-xs-6 col-sm-6">Room No</div>
                    <div class="col-xs-6 col-sm-6">: <?=$details->room_no?></div>
                </div>
                <div class="col-xs-12 col-sm-12 no-padding m-t-15">
                    <div class="col-xs-6 col-sm-6">Wallet Balance</div>
                    <div class="col-xs-6 col-sm-6">: <i class="fa fa-inr"></i> <?=$details->wallet_balance?></div>
                </div>
                <div class="col-xs-12 col-sm-12 no-padding">
                    <div class="col-xs-6 col-sm-6">Last Order</div>
                    <div class="col-xs-6 col-sm-6">: <i class="fa fa-inr"></i> <?php if($last_order->final_amount){echo $last_order->final_amount;}elseif($last_order->total_amount){ echo $last_order->total_amount;}else{echo '0';}?></div>
                </div>
        ...
        <div class="col-xs-12 col-sm-6 padding-top-10 border-left" id="statusbar">
            ...
            <div class="col-xs-12 col-sm-4 text-center p-t-40 p-b-40">
                <img class=" text-center" src="<?=BASE?>assets/img/loc.png" />
                <span class="bold col-sm-12 m-t-10">PICK UP</span>
            ...
            <div class="col-sm-4 text-center  p-t-40 p-b-40">
                <img class=" text-center" src="<?=BASE?>assets/img/bus.png" />
                <span class="bold col-sm-12">DELIVERY</span>
                <div class="col-sm-12"><?=$last_order->dropoff_time?date('d/m/Y',$last_order->dropoff_time):date('d/m/Y',($last_order->book_date + 24*60*60))?></div>
            ...
            <?php }?>
                ...
                <div class="col-sm-12 no-padding volet-bg">
                    <div class="container">
                ...
                <div class="col-sm-12 no-padding slotbox">
                    <div class="container">
                        <form method="post" id="orderFrm">
                        <div class="col-sm-12 m-t-40 no-padding box bg-white">
                            ...
                            <div id="dayopen" class="col-sm-12 no-padding bg-book">
                                ...
                                <div class="col-sm-12 p-l-15 qtybox">
                        ...
                        <div class="col-sm-12 qtybox no-padding margin-top-5 m-b-40">
                            <div class="col-sm-4 bold fs-16 bg-white padding-bottom-20 padding-top-20">
                                <div class="col-sm-6">
